...
Contributions to the SNU 3D Game Viewer mode are allowed, as long as you follow these contributing guidelines:

> * Keep it professional

> Please refrain from using swear words, slurs, and other bad words.
...
> These pages should be able to quickly load with less than 30 megabits of bandwidth speed. Please do not bog down page performance.
